...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    eslint: {
      ...
      test: {
        options: {
          configFile: 'js/tests/unit/.eslintrc'
        },
    ...
    watch: {
      src: {
        ...
        tasks: ['eslint:core', 'exec:karma', 'concat']
      },
      test: {
        files: '<%= eslint.test.src %>',
        tasks: ['eslint:test', 'exec:karma']
      },
      less: {
        files: 'less/**/*.less',
        tasks: ['less', 'copy']
  ...
  grunt.registerTask('test-js', ['eslint:core', 'eslint:test', 'eslint:grunt', 'exec:karma'])
  ...
  grunt.registerTask('lint-docs-js', ['eslint:assets'])
